			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li>
							<a href="cadastro_academico"><i class="fa fa-graduation-cap fa-fw"></i> Acadêmico</a>
						</li>
						<li class="divider"></li>
						<li>
			...
			<div class="panel panel-default col-md-8 col-md-offset-2">
				<div class="panel-body">
					...
					<small class="text-right">
						<a href="cadastro_academico.php">Oops! Não sou empregador!</a>
					</small>
					<hr>
					<form class="form-horizontal"  method="POST" action="controller/cadastro_empregador.php" >
						<div class="form-group">
							<label for="empresa" class="col-sm-2 control-label">Empresa:</label>

							<div class="col-sm-10">
								<input type="text" class="form-control" id="empresa" placeholder="Digite o nome da empresa" required name="nome">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="cnpj" placeholder="Digite o CNPJ da empresa" required name="cnpj">
							</div>
						</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
										<input type="text" class="form-control" id="nome" name = "telefone" placeholder="Digite seu telefone" required name="telefone">
								</div>
						</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
										<input type="text" class="form-control" id="nome" name = "endereco" placeholder="Digite seu endereço" required name="endereco">
								</div>
						</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-5">
										<input type="text" class="form-control" id="nome"  placeholder="Digite seu cidade" required name="cidade" >
								</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="email" class="form-control" id="email-cad" placeholder="Digite o e-mail da empresa" required name="email">
							</div>
						</div>
						<div class="form-group">
