                                ...
                                <div class="panel-body">
                                    <div class="pn-heading">
                                        <span class="pull-left">
                                            <strong>Atividades complentares
                                                <small class="text-muted">Edite sua atividade</small>
                                            </strong>
                                        </span>
                                    ...
                                    <?php if ($this->input->get('aviso') == 2) { ?>
                                        <div class="alert alert-success">
                                            Atividade complementar editada com sucesso!!!
                                        </div>
                                    <?php } ?>


                                    <form class="form-horizontal" action="<?= site_url('Painel_academico/salvaEditarAtividade') ?>" method="post">
