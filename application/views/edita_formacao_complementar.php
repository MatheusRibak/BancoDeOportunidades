                                ...
                                <div class="panel-body">
                                    <div class="pn-heading">
                                        <span class="pull-left">
                                            <strong>Formação Complementar
                                                <small class="text-muted">Cadastre sua Formação</small>
                                            </strong>
                                        </span>
                                    ...
                                    <?php if ($this->input->get('aviso') == 2) { ?>
                                        <div class="alert alert-success">
                                            Formação complementar cadastrada com sucesso!!!
                                        </div>
                                    <?php } ?>


                                    <form class="form-horizontal" action="<?= site_url('Formacao_complementar/editarFormacaoComplementar') ?>" method="post">
                                      <div class="form-group">
                                          <label for="formacao" class="col-sm-2 control-label">Formação Complementar</label>
                                          <div class="col-sm-9">
                                              <textarea name="formacao" class="form-control" cols="70" rows="7" placeholder="Digite a sua formação complementar..."><?php echo $dadosFormacao->atividade; ?></textarea>
                                          </div>
                                            <input type="hidden" name="id_atividade" value="<?php echo $dadosFormacao->id_atividade; ?>">
                                      </div>
                                      ...
                                      <div class="form-group">
                                          <div class="col-sm-offset-2 col-sm-10">
                                              <button type="submit" class="btn btn-primary">
                                                  Salvar Formacao <i class="fa fa-plus fa-fw"></i>
                                              </button>
                                          </div>
                                      </div>
                                    </form>
