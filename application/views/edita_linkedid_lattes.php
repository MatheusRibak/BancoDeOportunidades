                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="pn-heading">
                                        ...
                                        <span class="pull-left">
                                            ...
                                            <strong>LinkedIn | Lattes
                                                ...
                                                <small class="text-muted">Cadastre suas informaçõesc</small>
                                    ...
                                    <form class="form-horizontal" action="<?= site_url('Idioma/salvarEdicaoLinkedIdLattes') ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <input type="text" class="form-control cnpj" id="link" placeholder="https://www.linkedin.com/"  
                                                name="endereco" value="<?php echo $dadosL->endereco ?>">
                                                   <input type="hidden"  
                                                name="id_obs" value="<?php echo $dadosL->id_obs ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                               ...
                                               Edite o endereço de seu currículo do Lattes: http://lattes.cnpq.br<br>

                                               Edite o endereço de seu currículo do LinkedId: https://www.linkedin.com/
