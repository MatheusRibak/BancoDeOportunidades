			...
			<div class="row">
              ...
              <form class="form-horizontal"  method="POST" action="<?= base_url('academico/perfilEditado') ?>">
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control" id="nome" name = "nome" value="<?php echo $dadosAcademico->nome ?>" placeholder="Digite seu nome completo" required>
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control" id="nome" name = "endereco" value="<?php echo $dadosAcademico->endereco ?>" placeholder="Digite seu endereço" required>
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control" id="nome" name = "telefone" value="<?php echo $dadosAcademico->telefone ?>" placeholder="Digite seu telefone" required>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control" id="nome" name = "cidade" value="<?php echo $dadosAcademico->cidade ?>" placeholder="Digite seu cidade" required>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <select name="estado" lang="pt" class="form-control" name = "estado" required="" value="">
                  ...
                  <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                          <button type="submit" class="btn btn-primary">Salvar novos dados</button>
                      </div>
                  </div>
