                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <?php } ?>
                                <form class="form-horizontal"  method="POST" action="<?= site_url('Empregador/execAlterarEmpregado/' . $dadosEmpregador->id_empregador) ?>">
                                    <div class="form-group">
                                        <label for="cnpj" class="col-sm-2 control-label">CNPJ:</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control cnpj" id="cnpj" value="<?= $dadosEmpregador->cnpj ?>" name="cnpj">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="empresa" class="col-sm-2 control-label">Empresa:</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="empresa"  value="<?= $dadosEmpregador->nome_empresa ?>"  name="nome">
                                        </div>
                                    </div>    
                                    <div class="form-group">
